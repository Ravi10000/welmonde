  ...
  return (
    <>
      {isFetching ? (
        ...
        //           71-72, Jyoti Nivas College Road, 5th Block, Koramangala,
        //           Bangalore-560034. Represented by Laxmi , Director In
        //           International Business and hereinafter referred to as the
        //           First Party:
        //         </Text>
        ...
        //         </Text>
        //         <Text style={styles.margin}>
        //           Definitions: Unless repugnant to the context or meaning
        //           thereof, the capitalized terms defined herein shall have the
        //           following meaning:
        //         </Text>
        ...
        //             provide a mix of servces including individual procedures
        ...
        //             of healthcare and related services by one or more healthcare
        ...
        //             patient; or the referral of a patient for healthcare from
        ...
        //           <Text>5. </Text>
        //           <Text>
        //             Consultation: Means a consultation which takes place between
        //             a patient and a licensed physician for the purpose of
        ...
        //             computer interacts with the electronic device or computer,
        //             and includes the appearance, position and functionality of
        //             the start up screen, program launcher, and other common
        //             interface elements such as menus, buttons and dialog boxes,
        //             as well as the applications bundled with the system program,
        //             through which Welmonde Health Care Private Limited offers
        //             and carries out its services.
        //           </Text>
        //         </View>
        //         <View style={styles.list}>
        //           <Text>9. </Text>
        //           <Text>
        //             Privilege Card: A card issued to Welmonde Customers upon
        //             their first purchase of a package offered on the Welmonde
        //             User Interface.
        //           </Text>
        //         </View>
        //         <View
        ...
        //           </Text>
        //           <Text>
        //             Whereas the Second Party is in Healthcare Services having
        //             its business across India
        //           </Text>
        //         </View>
        //       </View>
        //     </Page>
        ...
        //               diagnostic centres/hospitals/clinics/customer and/or
        //               client locations which are approved and listed by the
        //               First Party and at the cost of the First Party.
        //             </Text>
        //           </View>
        //           <View style={{ ...styles.list }}>
        //             <Text>b. </Text>
        //             <Text>
        //               Providing specified consultations with me or several
        //               doctors approved and listed by the First Party and at the
        ...
        //             <Text>c. </Text>
        //             <Text>
        //               Providing any treatments as and when required by the
        //               customer of the first party upon the advice of the
        //               consultant of the second party or any other consultant who
        ...
        //         >
        //           <Text>
        //             Whereas the present agreement is concerned with the
        //             provision of facilities referred to in Clause A and B supra
        //           </Text>
        //           <Text>
        //             Whereas the Second Party in one of the Medical facilities
        //             has its own pharmacy approved and listed by the First Party
        //             for the purpose of providing medicine to the
        //             members/customers of the First Party,
        //           </Text>
        //           <Text>
        //             Whereas both parties mutually benefit from this contract in
        //             as much as the members customers of the First Party would
        //             get service from the Second Party and the Second Party gets
        //             an opportunity to give service and get paid for the service
        //             so rendered and also be known by a larger number of people
        //             which would, in turn, help them become more popular,
        //           </Text>
        //           <Text>
        //             Whereas although the First Party would be making payments to
        //             the Second Party for the services rendered by the Second
        //             Party to the member's customers of the First Party strictly
        //             in accordance with the terms of this agreement and strictly
        //             in conformity with and limited to what is stated in the
        //             Schedule hereunder, it is very clearly understood that
        //             except to the extent of liability to make payment for
        //             services to be rendered by the Second Party to the
        //             members/customers of the First Party, the First Party shall
        //             have no other obligation or liability whatsoever and
        //           </Text>
        //           <Text>
        ...
        //               member/customer, a corporate client of the First Party &
        //               his family members.
        //             </Text>
        //           </View>
        //           <View style={styles.list}>
        //             <Text>2. </Text>
        //             <Text>
        //               The Second Party shall give services to the customer
        //               member of the first party as agreed under the Schedule 1of
        //               this agreement with the First Party upon a mail
        //               communication or through online communication.
        //             </Text>
        //           </View>
        //           <View style={styles.list}>
        //             <Text>3. </Text>
        ...
        //               communicated to the first party through E-Mail or using
        //               the Welmonde user interface.
        //             </Text>
        //           </View>
        //           <View style={styles.list}>
        //             <Text>4. </Text>
        ...
        //             agreement to the ether Party. In the event of termination
        ...
        //             due to any default or negligence in providing or performing
        //             the Medical services shall be borne exclusively by the
        //             Second Party who alone shall be responsible for the defect
        //             and/or deficiencies in rendering such Medical services.
        //           </Text>
        //         </View>
        //         <View style={styles.list}>
        //           <Text>2.</Text>
        ...
        //             directors, employees, agents and affiliates against all
        //             actions, suits, claims and demands brought or made against
        //             it in respect of anything done or purported to be done by
        //             the Second Party in connection with the responsibilities or
        //             services under these Terms and against any loss or damage
        //             caused to The First Party in consequence of any action or
        //             suit being brought against The First Party, along with the
        //             Second Party or otherwise, for anything done or purported to
        //             be done in the course of the performance of services under
        //             these Terms.
        //           </Text>
        //         </View>
        //         <View style={styles.list}>
        ...
        //       <View style={styles.section}>
        //         <Text>
        //           accuracy, or rates charged by the Second Party and/or any
        //           other aspect of any service provided to any Customer/member of
        //           The First Party by the Second Party. The Second Party hereby
        //           agrees to indemnify, defend and hold harmless The First Party,
        //           it's present and former officers, directors, employees,
        //           agents, and affiliates from and against any losses, claims,
        //           damages, liabilities, costs, or expenses (including reasonable
        //           attorney's fees and expenses of investigation) incurred by The
        //           First Party in relation to the Medical services provided by
        //           the Second Party to any Customer/member of the First Party
        //           Member.
        //         </Text>
        //         <View style={styles.list}>
        //           <Text>8.</Text>
        ...
        //             party in case the appointment is given and the service is
        //             done. However, the second party has the freedom to deny
        //             appointments raised by the first party for its
        ...
        //             outpatient consultation fees (Excluding consumables and
        //             Pharmacy Bill)
        //           </Text>
        //           <Text
        //             style={{
