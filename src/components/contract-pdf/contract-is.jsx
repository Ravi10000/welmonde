...
function ContractInternational({ client, contract }) {
        ...
        <View style={styles.section}>
          ...
          <View style={styles.content}>
            ...
            <Text style={{ marginHorizontal: 10 }}>
              ...
              having its registered office at, 71-72, Jyoti Nivas College Road,
              5th Block, Koramangala, Bangalore-560034. Represented by LAXMI,
              Director (International Business) and here in after referred to as
              the First Party:
            </Text>
            ...
            <View style={{ gap: 5 }}>
              <Text>
                Whereas the First Party is in the business of providing curative
                and Preventive Health Care and other Medical Services to its
                members/customers like healthcare services including surgeries
                and critical care, wellness services including wellness tourism,
                digital fitness platform, e-pharmacy, alternate medicine,
                veterinary medicine, nursing services and many more. Whereas the
                Second Party is in ……………………. Whereas as a matter of good
                gesture, various services are provided by the First Party in its
                business, although it is not obliged to, and they include the
                following
              </Text>
              ...
              <View style={styles.listItem}>
                ...
                <Text>
                  ...
                  centres/hospitals/clinics or client locations which are
                  approved and listed by the First Party and at the cost of the
                  First Party.
                </Text>
              </View>
              ...
              <Text style={{ marginTop: 10 }}>
                ...
                service from the first Party. Whereas the parties have finalized
                the terms and thought it fit to reduce the terms so agreed upon
                between them into writing.
              </Text>
            </View>
            <Text
              style={{
            ...
            <View style={styles.listItem}>
              ...
              <Text>
                ...
                the second Party as agreed under the Schedule of this agreement
            ...
            <View style={styles.listItem}>
              <Text>2. </Text>
              <Text>
                The first party will provide a written communication or confirm
                ...
                the appointment the same shall be communicated to the second
                party through E-Mail or using the Welmonde user interface and
                vice-versa.
              </Text>
            </View>
            <View style={styles.listItem}>
              ...
              <Text>
                ...
                with the consent of the member/customer and/or the second Party
              </Text>
            </View>
          </View>
        </View>
          ...
          <View style={styles.content}>
            ...
            <View style={styles.listItem}>
              ...
              <Text>
                ...
                second party which may deem fit for the first party and with the
            ...
            <View style={styles.listItem}>
              ...
              <Text>
                ...
                Party and the Second party shall be the same relation that would
                and if the members/customers of the second Party had
            ...
            <View style={styles.listItem}>
              <Text>1. </Text>
              <Text>
                The first Party hereby agrees that any liability arising due to
                any default or negligence in providing or performing the Medical
                services shall be borne exclusively by the first Party who alone
            ...
            <View style={styles.listItem}>
              ...
              <Text>
                ...
                relation to the medical services provided by the first Party to
                any Customer/member of the second Party Member.
              </Text>
            </View>
            <Text
              style={{
            ...
            <Text>
              ...
              the client or member of second party in the cause of the event and
              it should be paid on completion of the service and payment done by
              client or member of second party and payment should be given
              through the agreed bank account of second party and first party
              shall not have any liability if the second party additionally
              charged from their client for the other services provided by the
              second party.
            </Text>
            <Text style={{ marginTop: 10 }}>
...
export default ContractInternational;
