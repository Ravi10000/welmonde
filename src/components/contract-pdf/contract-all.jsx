    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          ...
          <Text>
            ...
            , authorized Signatory and herein after referred to as second Party.
          </Text>
          <Text style={styles.margin}>
            Definitions: Unless repugnant to the context or meaning thereof, the
            capitalized terms defined herein shall have the following meaning:
          </Text>
          <View style={styles.list}>
            <Text>1. </Text>
            <Text>
              Health Package: Means the healthcare packages devised to provide a
              mix of servces including individual procedures (medical procedure
              or intervention, or treatment) and/or Diagnostic Services.
            </Text>
          </View>
          <View style={styles.list}>
            <Text>2. </Text>
          ...
          <View style={styles.list}>
            ...
            <Text>
              ...
              providers, including the coordination or management of healthcare
              by a healthcare provider with a third party; consultation between
              healthcare providers relating to a patient; or the referral of a
              patient for healthcare from one healthcare provider to another.
            </Text>
          </View>
          <View style={styles.list}>
            <Text>4. </Text>
          ...
          <View style={styles.list}>
            ...
            <Text>
              ...
              what medical examinations or procedures, if any, are appropriate.
            </Text>
          </View>
          <View style={styles.list}>
            <Text>6. </Text>
          ...
          <View style={styles.list}>
            <Text>7. </Text>
            <Text>
              Member: Shall mean any person who has purchased a package offered
              on the Welmonde User Interface.
            </Text>
          </View>
          <View style={styles.list}>
            <Text>8. </Text>
          ...
          >
            ...
            <Text>
              Whereas the First Party is in the business of providing Preventive
              HealthCare and other Medical Services to its members/customers;
            </Text>
            <Text>
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          <View>
            <Text>
              Whereas as a matter of good gesture, various services are provided
              by the First Party in its business, although it is not obliged to,
            ...
            <View style={{ ...styles.list }}>
              ...
              <Text>
                ...
                centres/hospitals/clinics/customer and/or client locations which
                are approved and listed by the First Party and at the cost of
                the First Party.
              </Text>
            </View>
            <View style={{ ...styles.list }}>
            ...
            <View style={{ ...styles.list }}>
              <Text>c. </Text>
              <Text>
                Providing any treatments as and when required by the customer of
                the first party upon the advice of the consultant of the second
                party or any other consultant who is a registered medical
                practitioner.
              </Text>
            </View>
          </View>
          <View style={{ display: "flex", gap: "10px", marginTop: "20px" }}>
            ...
            <Text>
              Whereas the Second Party in one of the Medical facilities has its
              own pharmacy approved and listed by the First Party for the
            ...
            <Text>
              ...
              much as the members customers of the First Party would get service
              from the Second Party and the Second Party gets an opportunity to
              give service and get paid for the service so rendered and also be
              known by a larger number of people which would, in turn, help them
              become more popular,
            </Text>
            <Text>
              Whereas although the First Party would be making payments to the
              Second Party for the services rendered by the Second Party to the
              member's customers of the First Party strictly in accordance with
              the terms of this agreement and strictly in conformity with and
              limited to what is stated in the Schedule hereunder, it is very
              clearly understood that except to the extent of liability to make
              payment for services to be rendered by the Second Party to the
              members/customers of the First Party, the First Party shall have
              no other obligation or liability whatsoever and
            </Text>
            <Text>
              Whereas the parties have finalized the terms and thought it fit to
              reduce the terms so agreed upon between them into writing.
            </Text>
          </View>
          <View style={{ display: "flex", gap: "10px", marginTop: "20px" }}>
            <View
            ...
            <View style={styles.list}>
              ...
              <Text>
                ...
                the first party as agreed under the Schedule 1of this agreement
                with the First Party upon a mail communication or through online
                communication.
              </Text>
            </View>
            <View style={styles.list}>
              <Text>3. </Text>
              <Text>
                The Second party will provide a written communication or confirm
                the appointment online using the Welmonde user interface as
                confirmation for such appointments or in case of any changes in
                the appointment the same shall be communicated to the first
                party through E-Mail or using the Welmonde user interface.
              </Text>
            </View>
            <View style={styles.list}>
              <Text>4. </Text>
            ...
            <View style={styles.list}>
              <Text>5. </Text>
              <Text>
                The appointments for the services to be delivered by the Second
                Party shall be predetermined by the first party on behalf of its
                member/customer or through an agent of the First Party.
              </Text>
            </View>
          </View>
        </View>
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          ...
          <View style={styles.list}>
            <Text>7. </Text>
            <Text>
              First Party will provide the second party with a user interface to
              which the second party can upload all the test results or any such
              documents related to the services rendered by the second party
              including but not limited to health check reports, medical
          ...
          <View style={styles.list}>
            ...
            <Text>
              ...
              party on the day of the appointment or in case the customer member
              of the first party wants to avail of any medical services from the
              second party.
            </Text>
          </View>
          <View style={styles.list}>
          ...
          <View style={styles.list}>
            ...
            <Text>
              ...
              upload such data in the user interface provided by the first party
              so as to provide appointments to the customer/member of the first
              party by means of the online or offline channel.
            </Text>
          </View>
          <View style={styles.list}>
            <Text>12. </Text>
            <Text>
              ...
              handling any queries or clarifications of the first party and also
              in case of escalations or any other queries related to services.
            </Text>
          </View>
          <View style={styles.list}>
            <Text>13. </Text>
            <Text>
              ...
              within a period of 15 days from the date of the invoice along with
              the details of the health checks upon due validation by the First
              Party or any other agency appointed for the same.
            </Text>
          </View>
          <View style={styles.list}>
            <Text>14. </Text>
            <Text>
              The Second party should not share the prices agreed with the First
              party agreed under this agreement with the customer/member of the
              first party. In case of any such disclosures, the first party
              holds the right to hold the payments of the second party for such
              services rendered.
            </Text>
          </View>
          <View style={styles.list}>
          ...
          <View style={styles.list}>
            <Text>16. </Text>
            <Text>
              The inter-se relationship of the customers of the First Party and
              the Second Party is on the basis that there is a direct contract
              between them and the First Party shall have no role to play in the
              consultation sought by the member/customer of the First Party and
              consultation given by the Second Party except to the extent of
              making payment as per this agreement subject to maximum liability
              as mentioned in the schedule hereunder.
            </Text>
          </View>
          <View style={styles.list}>
            <Text>17. </Text>
            <Text>
              ...
              and as such the inter-relationship between the member/customer of
              the First Party and the Second Party is totally and absolutely
          ...
          <View style={styles.list}>
            ...
            <Text>
              ...
              think fit and consequent upon such advice if any service rendered
              by the Second Party beyond what is contemplated in the Schedule or
              if such service were to cost any amount in excess of the maximum
              liability fixed under this agreement, it shall be a matter between
              the Second Party and the members/customers of the First Party and
              the First Party shall not be answerable to the same.
            </Text>
          </View>
        </View>
      </Page>
        ...
        <View style={styles.section}>
          <View style={styles.list}>
            ...
            <Text>
              ...
              Party shall be to the extent of making payment as mentioned in the
              Schedule and under no circumstances and for no reason the
          ...
          <View style={styles.list}>
            ...
            <Text>
              ...
              facilities/consultations/checks to be given by the Second Party to
              the member/customer of the First Party and the amount payable to
              the Second Party by the First Party for services so rendered.
            </Text>
          </View>
          <View style={styles.list}>
            <Text>21. </Text>
            <Text>
              ...
              Agreement shall become void and shall have no effect, without any
              liability on the part of any of the parties or their directors,
              officers, or shareholders in respect of this Agreement.
            </Text>
          </View>
          <View style={styles.list}>
            <Text>22. </Text>
            <Text>
              ...
              liabilities, and entitlement or to the interpretation of any terms
              of this agreement, the same shall be referred to the arbitration
              of person(s) acceptable to both the parties and the decision shall
          ...
          <View style={styles.list}>
            ...
            <Text>
              ...
              services shall be borne exclusively by the Second Party who alone
              shall be responsible for the defect and/or deficiencies in
          ...
          <View style={styles.list}>
            ...
            <Text>
              ...
              suits, claims and demands brought or made against it in respect of
              anything done or purported to be done by the Second Party in
              connection with the responsibilities or services under these Terms
              and against any loss or damage caused to The First Party in
              consequence of any action or suit being brought against The First
              Party, along with the Second Party or otherwise, for anything done
              or purported to be done in the course of the performance of
          ...
          <View style={styles.list}>
            <Text>5.</Text>
            <Text>
              The Second Party shall at all times abide by the statutory and/or
              regulatory requirements prevalent in India and shall keep free and
              indemnify The First Party from all demands or responsibilities
              arising from accidents or loss of life, the cause or result of
              which is negligence or misconduct on the part of the Second Party.
            </Text>
          </View>
          <View style={styles.list}>
            <Text>6.</Text>
          ...
          <View style={styles.list}>
            ...
            <Text>
              ...
              services to be rendered to the Customer/member of The First Party,
              The First Party shall not be liable in any manner whatsoever for
      ...
      <Page style={styles.page} size="A4">
        <View style={styles.section}>
          <Text>
            ...
            from and against any losses, claims, damages, liabilities, costs, or
            ...
            Medical services provided by the Second Party to any Customer/member
            of the First Party Member.
          </Text>
          <View style={styles.list}>
            <Text>8.</Text>
            <Text>
              ...
              appointment is given and the service is done. However, the second
              party has the freedom to deny appointments raised by the first
              party for its members/customers for services rendered by the
              second party.
            </Text>
          </View>
          <View
          ...
          >
            <Text style={{ borderBottom: "2px solid black" }}>SCHEDULE I</Text>
            <Text
              style={{
            ...
            <Text>
              All Health Packages, services and consultation should be given on
              agreed rates by First Party and Second Party
            </Text>
          </View>
          <View
            style={{
          ...
          >
            ...
            <Text>
              Second Party agrees to pay 20% of any service provided per patient
              to the first party as SERVICE CHARGE
              {/* and provide
